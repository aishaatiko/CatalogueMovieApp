...
public class FavoriteMoviesWidget extends AppWidgetProvider {
    ...
    private static final String TOAST_ACTION = "com.nct.darkchocolate.cataloguemovieapp.TOAST_ACTION";
    public static final String EXTRA_ITEM = "com.nct.darkchocolate.cataloguemovieapp.EXTRA_ITEM";
